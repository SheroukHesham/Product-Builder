...
const Select = ({ selected, setSelectedCategory }: IProps) => {
  console.log("selected", selected);
  return (
    // **TODO: Fix the value type -- an error shows in console on submit  **  //
    <Listbox value={selected} onChange={setSelectedCategory}>
      {({ open }) => (
        <>
